...
* Melhoria de mantenabilidade do código
...
### Component Based
Enfatiza a construção de aplicações pela composição de componentes de interface do usuário reutilizáveis. Estimula o encapsulamento, modularidade e a reutilização
#### Vantagens
...
* Ferramentas comuns: Vite ou o modo "SPA" de frameworks mais completos, como o React Router
...
* Ferramentas comuns: A implementação manual do SSR com React e Node.js é possível, mas complexa. A própria documentação do React recomenda o uso de frameworks que já incorporam essa funcionalidade, como o Next.js ou o React Router
...
* A navegação entre páginas subsequente acontece no cliente, como em uma SPA, sem recarregar a página inteira, o que torna a navigation muito fluida
